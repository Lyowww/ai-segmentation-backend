...
Also detect any food waste items and containers with visible food/drink residue. Return ONLY valid JSON:
{
  ...
  "organics_contamination_items": ["one short text per non-organic item that should be removed before putting waste in the organic bin"]
}
...
Return ONLY valid JSON object. If no products are detected, return {"products": [], "food_waste_items": [], "containers_with_food_or_drink": [], "organics_contamination_present": false, "organics_contamination_items": []}. Do not include any markdown formatting or additional text.`;
