...
/**
 * Resolve an image from a multipart file, a base64 form/JSON field (`imageData`),
 * or a remote URL (`imageUrl`). Base64 and URL inputs keep request bodies small
 * enough for Vercel's 4.5 MiB serverless payload cap.
 */
